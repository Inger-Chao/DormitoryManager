 ...
 */
class StudentManageSelfFrame() : StackFrame("StudentInfo"), ActionListener {


    val infoPanel = StudentInfoRender(SelectStudentsInfo().select(UserService.getInstance().currentUser.no))
